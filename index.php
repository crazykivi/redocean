...
if (!empty($theme)) {
    $theme = $pdo->quote($theme); // Предположим, что в theme передается ID темы
...
echo "<script>
    var searchQuery = '" . htmlspecialchars($searchQuery, ENT_QUOTES) . "';
    var themes = '" . htmlspecialchars($themes, ENT_QUOTES) . "';
</script>";
