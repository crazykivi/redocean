...
$query = "SELECT id_themes_video,name_themes FROM themes_video";
    ...
    <section class="video-list">
        ...
        if ($stmt->rowCount() > 0) {
            ...
            <div class='video-container'>
                <a href='index?themes={$row['id_themes_video']}'>
                    <img src='video/themes.png' alt='Превью видео'>
                    <div class='video-info'>
                        <div class='video-title'>{$row['name_themes']}</div>
                    </div>
                </a>
            </div>
        </div>";
